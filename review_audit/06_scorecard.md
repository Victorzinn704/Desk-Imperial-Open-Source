...
| Segurança & LGPD            | **7.5**     | SEC: cookie HttpOnly+Secure+SameSite+\_\_Host-, CSRF double-submit, Argon2id, CORS restritivo. Enumeração de usuário em 3 endpoints. Sem exclusão de conta. |
