...
- `docs/security/*` baselines, checklists vivos e threat models
...
4. se a mudanca sera publicada no open source, seguir `docs/operations/open-source-sync-runbook.md` e abrir PR no remoto `public`, nunca push direto em `public/main`
5. rodar:
