...
> Todo PRD que cria módulo novo também DEVE preencher o `Code Health Budget` de `docs/architecture/code-health-creation-workflow.md`.
...
- [ ] Nenhuma função nova excede 50 linhas
- [ ] O arquivo público principal é facade/orquestrador quando houver mais de uma responsabilidade
...
- [ ] Testes com muitos casos usam tabela/fixture fora do `it`
