...
1. **Intento de produto**
   ...
   - Orçamento de Code Health conforme `docs/architecture/code-health-creation-workflow.md`
...
7. **Verificação final**
   ...
   - Riscos restantes
   - Confirmação de que nenhum arquivo tocado degradou sem justificativa
...
- O `Code Health Budget` foi preenchido quando a mudança criou código novo relevante?
