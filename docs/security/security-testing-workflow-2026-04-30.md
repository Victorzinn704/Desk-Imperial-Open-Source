...
- `docs/security/threat-model-critical-flows.md` -> ameacas, controles, lacunas e matriz de testes negativos por fluxo critico
...
Antes de rodar ferramenta, confirme se a mudanca toca algum fluxo do threat model:

```bash
docs/security/threat-model-critical-flows.md
```

Se tocar auth, workspace, realtime, Mercado Pago, Telegram, impressao ou observabilidade, a mudanca precisa de teste negativo ou justificativa documentada.
