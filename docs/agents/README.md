...
| `32-frontend-product-lead-agent.md`  | Staff Frontend / Tech Lead de Produto | Direção sênior de frontend, SaaS dashboards, UX/UI, composição e maturidade visual |
...
- **32 vs 16/17/28:** Frontend Product Lead = direção sênior e julgamento de produto; 28 planeja fluxo, 17 refina sistema visual e 16 implementa com segurança.
