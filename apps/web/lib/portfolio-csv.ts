...
export function downloadProductTemplateCsv() {
  const csv = buildCsv([
    PRODUCT_CSV_HEADERS,
    ['Refrigerante Cola 2L', 'Coca-Cola', 'Bebidas', 'Fardo Refrigerante 2L - 6 und', 'L', '2', '6', 'Fardo com 6 unidades de 2 litros.', '8.50', '12.90', '4', '3', '27', 'BRL'],
    ['Cerveja Lata 350ml', 'Brahma', 'Bebidas', 'Lata - 12 und de 350ml', 'ML', '350', '12', 'Caixa com latas de 350 ml para venda rapida.', '5.20', '8.40', '3', '0', '36', 'BRL'],
  ])
