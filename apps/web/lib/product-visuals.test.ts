...
describe('resolveProductVisual', () => {
  ...
  it('nao inventa packshot para cerveja de marca quando nao existe imagem real cadastrada', () => {
    const visual = resolveProductVisual({
      name: 'Heineken 350ml',
      brand: 'Heineken',
      category: 'Cervejas',
  ...
  it('nao usa foto curada para Brahma quando ela nao representa o produto embalado', () => {
    const visual = resolveProductVisual({
      name: 'Brahma 350ml',
      brand: 'Brahma',
      category: 'Cervejas',
  ...
  it('ignora url insegura sem cair em imagem local inventada', () => {
    const visual = resolveProductVisual({
  ...
  it('nao inventa packshot local para Guaravita sem foto real', () => {
    const visual = resolveProductVisual({
      name: 'Guaravita',
      brand: 'Guaravita',
      category: 'Outros',
  ...
  it('nao usa packshot nacional para Bohemia quando nao ha foto real', () => {
    const visual = resolveProductVisual({
      name: 'Bohemia 600ml',
      brand: 'Bohemia',
      category: 'Cervejas',
  ...
  it('nao inventa packshot para Skol sem foto real', () => {
    const visual = resolveProductVisual({
      name: 'Skol 350ml',
      brand: 'Skol',
      category: 'Cervejas',
  ...
  it('nao inventa packshot para Coca-Cola sem foto real', () => {
    const visual = resolveProductVisual({
      name: 'Coca-Cola Lata',
      brand: 'Coca-Cola',
  ...
  it('nao inventa packshot para Guarana Antarctica sem foto real', () => {
    const visual = resolveProductVisual({
  ...
  it('nao inventa packshot local para cerveja generica sem foto real', () => {
    const visual = resolveProductVisual({
