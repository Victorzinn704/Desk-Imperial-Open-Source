...
export function SaveButtons({
  ...
  return (
    <div className="mt-4 grid grid-cols-1 gap-3 min-[430px]:grid-cols-2">
      <button
        className="min-h-12 w-full rounded-[14px] border border-[var(--border)] bg-[var(--surface)] px-3 py-3 text-sm font-semibold text-[var(--text-primary)] transition-all hover:border-[var(--border-strong)] hover:bg-[var(--surface-soft)] disabled:cursor-not-allowed disabled:opacity-40"
      ...
      <button
        className="flex min-h-12 w-full items-center justify-center gap-2 rounded-[14px] border px-3 py-3 text-sm font-semibold text-[var(--success)] transition-all disabled:cursor-not-allowed disabled:opacity-40"
