...
export const ComandaFormPane = memo(function ComandaFormPane(props: FormPaneProps) {
  return (
    <div className="flex min-h-0 min-w-0 flex-col overflow-y-auto border-b border-[var(--border)] lg:col-start-2 lg:row-start-1 2xl:col-start-auto 2xl:row-start-auto 2xl:border-b-0 2xl:border-r">
      <ComandaPartyFields
...
function ComandaPartyFields({
  ...
  return (
    <div className="grid grid-cols-1 gap-3 p-4 pb-2 min-[430px]:grid-cols-2">
  ...
  return (
    <div className="px-4 pb-3">
      ...
      <div className="flex gap-2">
        <input
          className="min-h-11 flex-1 rounded-[12px] border bg-[var(--surface)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none transition-colors"
          id={documentInputId}
          inputMode="numeric"
        ...
        {clienteDocumento ? (
          <button
            aria-label="Limpar CPF ou CNPJ"
            className="flex size-11 shrink-0 items-center justify-center rounded-[12px] border border-[var(--border)] text-[var(--text-soft)] hover:border-[var(--border-strong)] hover:text-[var(--text-primary)]"
            type="button"
...
function ComandaPercentFields({
  ...
  return (
    <div className="grid grid-cols-1 gap-3 px-4 pt-1 min-[430px]:grid-cols-2">
...
function ComandaTotalCard({
  ...
  return (
    <div
      className="m-4 flex flex-wrap items-center justify-between gap-3 rounded-[14px] border px-4 py-3"
      style={{
...
function ComandaFooter(
  ...
  return (
    <div className="sticky bottom-0 mt-auto border-t border-[var(--border)] bg-[color-mix(in_srgb,var(--surface)_94%,transparent)] p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] backdrop-blur">
      <SaveButtons
        connectionState={props.connectionState}
...
function InputField({
  ...
  return (
    <div>
      ...
      <input
        className="min-h-11 w-full rounded-[12px] border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none focus:border-[var(--accent)]"
        id={inputId}
