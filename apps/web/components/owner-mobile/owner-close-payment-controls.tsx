...
type CreatePaymentHandler = (id: string, amount: number, method: ComandaPaymentMethod) => Promise<unknown> | undefined

export function useOwnerClosePaymentState(
...
export function OwnerPaymentSummary({ paidAmount, remainingAmount }: { paidAmount: number; remainingAmount: number }) {
  return (
...
export function OwnerPaymentMethodGrid({
  isBusy,
  paymentMethod,
...
export function OwnerPartialPaymentControls({
  activeComanda,
  canRegisterPartial,
  isBusy,
  normalizedPartialAmount,
...
export function roundInputMoney(value: number) {
