...
import { useCreateComandaPaymentMutation } from './use-owner-mobile-comanda-payment-mutation'
import { useCreateComandaTerminalPaymentIntentMutation } from './use-owner-mobile-terminal-payment-mutation'
...
export function useOwnerMobileShellMutations(queryClient: QueryClient, router: RouterLike) {
  return {
    ...
    createComandaTerminalPaymentIntentMutation: useCreateComandaTerminalPaymentIntentMutation(queryClient),
