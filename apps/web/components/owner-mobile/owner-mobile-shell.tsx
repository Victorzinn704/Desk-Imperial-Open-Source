...
function OwnerShellMain({
  ...
  return (
    <main
      className={`mobile-scroll-surface app-mobile-scroll relative min-h-0 flex-1 ${
        isPdvBuilderOpen ? 'flex flex-col overflow-hidden pb-0' : 'app-mobile-bottom-safe overflow-y-auto'
      }`}
      ref={containerRef}
    >
...
export function OwnerMobileShell({ currentUser }: OwnerMobileShellProps) {
  ...
  return (
    <div className="app-mobile-viewport flex flex-col bg-[var(--bg)] text-[var(--text-primary)]">
