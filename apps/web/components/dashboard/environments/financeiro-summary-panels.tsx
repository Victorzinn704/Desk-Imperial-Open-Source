...
function FinanceRadarPanel({
  ...
  return (
    ...
    >
      <div className="workspace-notebook-split workspace-notebook-split--main-135 workspace-notebook-split--rail-280 gap-6">
        <div className="space-y-5">
        ...
        <div className="space-y-4 border-t border-dashed border-[var(--lab-border)] pt-4 min-[1080px]:border-l min-[1080px]:border-t-0 min-[1080px]:pl-5 min-[1080px]:pt-0">
