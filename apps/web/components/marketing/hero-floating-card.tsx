  ...
  return (
    <>
      <motion.aside
        ...
        className="pointer-events-none absolute top-[7.45rem] z-10 hidden w-[248px] rounded-[30px] border border-[rgba(255,255,255,0.08)] bg-[rgba(10,13,18,0.72)] p-4 shadow-[0_26px_80px_rgba(0,0,0,0.34)] backdrop-blur-xl lg:block xl:w-[264px]"
