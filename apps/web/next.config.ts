...
const securityHeaders = [
  ...
  { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
  {
    ...
    value:
      'camera=(self), bluetooth=(self), usb=(self), serial=(self), microphone=(), geolocation=(), interest-cohort=()',
  },
  {
  ...
  },
  {
    ...
    value: [
      ...
      `connect-src 'self' ${localApiConnectOrigins} ${qzTrayConnectOrigins} https://api.deskimperial.online wss://api.deskimperial.online https://app.deskimperial.online https://*.basemaps.cartocdn.com ${observabilityConnectOrigins}`,
