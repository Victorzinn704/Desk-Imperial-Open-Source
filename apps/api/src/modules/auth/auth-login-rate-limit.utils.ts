...
export function buildRateLimitMetadata(rateLimitState: { count: number; lockedUntil: number | null }) {
  return {
...
export function buildOptionalRateLimitMetadata(rateLimitState: { count: number; lockedUntil: number | null } | null) {
  return rateLimitState ? buildRateLimitMetadata(rateLimitState) : { attempts: null, lockedUntil: null }
}
