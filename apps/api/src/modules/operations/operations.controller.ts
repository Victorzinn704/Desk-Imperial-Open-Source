...
import {
  ...
  type CreateComandaTerminalPaymentIntentDto,
...
const createComandaTerminalPaymentIntentBodyPipe = new ZodValidationPipe(createComandaTerminalPaymentIntentBodySchema)
...
export class OperationsController {
  constructor(
    ...
    private readonly terminalPayments: ComandaTerminalPaymentService,
  ) {}
  ...
  @UseGuards(SessionGuard, CsrfGuard)
  @Post('comandas/:comandaId/terminal-payment-intents')
  createComandaTerminalPaymentIntent(
    @CurrentAuth() auth: AuthContext,
    @Param('comandaId') comandaId: string,
    @Body(createComandaTerminalPaymentIntentBodyPipe) body: CreateComandaTerminalPaymentIntentDto,
    @Req() request: Request,
  ) {
    return this.terminalPayments.createIntent({ auth, comandaId, context: extractRequestContext(request), dto: body })
  }
