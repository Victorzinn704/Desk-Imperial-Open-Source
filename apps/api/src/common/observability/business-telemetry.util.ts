...
const operationsSummaryDuration = meter.createHistogram('desk.operations.summary.duration', {
  description: 'Tempo de montagem do resumo executivo operacional',
  unit: 'ms',
})

const operationsSummaryPerformers = meter.createHistogram('desk.operations.summary.performers', {
  description: 'Quantidade de colaboradores ranqueados no resumo operacional',
  unit: '{performer}',
})

const operationsSummaryTopProducts = meter.createHistogram('desk.operations.summary.top_products', {
  description: 'Quantidade de produtos ranqueados no resumo operacional',
  unit: '{product}',
})
...
export function recordOperationsSummaryTelemetry(
  durationMs: number,
  shape: {
    performers: number
    topProducts: number
  ...
  operationsSummaryDuration.record(durationMs, attributes)
  operationsSummaryPerformers.record(shape.performers, attributes)
  operationsSummaryTopProducts.record(shape.topProducts, attributes)
}
