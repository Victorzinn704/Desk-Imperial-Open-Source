...
export const paymentTerminalProviderSchema = z.enum(['MERCADO_PAGO_POINT'])
...
export const paymentTerminalIntentRecordSchema = z.object({
  id: z.string(),
  comandaId: z.string(),
  amount: z.number(),
  method: comandaPaymentMethodSchema,
...
export type PaymentTerminalIntentRecord = z.infer<typeof paymentTerminalIntentRecordSchema>
