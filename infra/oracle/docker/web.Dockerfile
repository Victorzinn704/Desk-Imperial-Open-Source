...
ARG NEXT_PUBLIC_SENTRY_SEND_DEFAULT_PII
ARG NEXT_PUBLIC_SENTRY_ENABLE_LOGS
ARG SENTRY_WEB_DSN
ARG SENTRY_WEB_ENABLED
ARG SENTRY_WEB_TRACES_SAMPLE_RATE
ARG SENTRY_WEB_ENVIRONMENT
ARG SENTRY_WEB_RELEASE
ARG SENTRY_WEB_SEND_DEFAULT_PII
ARG SENTRY_WEB_ENABLE_LOGS
ARG SENTRY_ORG
...
ENV NEXT_PUBLIC_SENTRY_SEND_DEFAULT_PII=${NEXT_PUBLIC_SENTRY_SEND_DEFAULT_PII}
ENV NEXT_PUBLIC_SENTRY_ENABLE_LOGS=${NEXT_PUBLIC_SENTRY_ENABLE_LOGS}
ENV SENTRY_WEB_DSN=${SENTRY_WEB_DSN}
ENV SENTRY_WEB_ENABLED=${SENTRY_WEB_ENABLED}
ENV SENTRY_WEB_TRACES_SAMPLE_RATE=${SENTRY_WEB_TRACES_SAMPLE_RATE}
ENV SENTRY_WEB_ENVIRONMENT=${SENTRY_WEB_ENVIRONMENT}
ENV SENTRY_WEB_RELEASE=${SENTRY_WEB_RELEASE}
ENV SENTRY_WEB_SEND_DEFAULT_PII=${SENTRY_WEB_SEND_DEFAULT_PII}
ENV SENTRY_WEB_ENABLE_LOGS=${SENTRY_WEB_ENABLE_LOGS}
...
RUN SENTRY_AUTH_TOKEN="${SENTRY_AUTH_TOKEN}" npm run build --workspace @partner/web
